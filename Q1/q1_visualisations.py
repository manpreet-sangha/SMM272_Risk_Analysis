"""
Q1 – Step 6: All visualisations (9 figures).
"""
...
def generate_visualisations(prices=None, log_returns=None,
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(Q1_OUTPUT_DIR, "fig1_normalised_prices.png"))
    plt.show()
    ...
    plt.xticks(rotation=45)
    plt.tight_layout()
    plt.savefig(os.path.join(Q1_OUTPUT_DIR, "fig2_cumulative_returns.png"))
    plt.show()
    ...
    plt.xticks(rotation=45)
    plt.tight_layout()
    plt.savefig(os.path.join(Q1_OUTPUT_DIR, "fig3_daily_returns.png"))
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(Q1_OUTPUT_DIR, "fig4_histogram_normal_kde.png"))
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(Q1_OUTPUT_DIR, "fig5_qq_plot.png"))
    plt.show()
    ...
    plt.xticks(rotation=45)
    plt.tight_layout()
    plt.savefig(os.path.join(Q1_OUTPUT_DIR, "fig6_boxplots.png"))
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(Q1_OUTPUT_DIR, "fig7_correlation_heatmap.png"))
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(Q1_OUTPUT_DIR, "fig8_acf_plots.png"))
    plt.show()
    ...
    plt.xticks(rotation=45)
    plt.tight_layout()
    plt.savefig(os.path.join(Q1_OUTPUT_DIR, "fig9_rolling_statistics.png"))
    plt.show()

    print(f"\nAll 9 figures saved to: {Q1_OUTPUT_DIR}")
